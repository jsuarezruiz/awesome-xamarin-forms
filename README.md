...
- [awesome-xamarin ★1686](https://github.com/benoitjadinon/awesome-xamarin): A collection of interesting libraries/tools for Xamarin mobile projects.
...
- [LottieXamarin ★1097](https://github.com/martijn00/LottieXamarin): Render After Effects animations natively on Android and iOS for Xamarin.
- [Xamanimation ★396](https://github.com/jsuarezruiz/Xamanimation): Xamarin.Forms animation library.
...
- [Ooui ★1478](https://github.com/praeclarum/Ooui): A small cross-platform UI library that brings the simplicity of native UI development to the web.
...
- [Entity Framework Core ★10157](https://github.com/aspnet/EntityFrameworkCore): Is a lightweight and extensible version of the popular Entity Framework data access technology.
- [LiteDB ★5728](https://github.com/mbdavid/LiteDB): A .NET NoSQL Document Store in a single data file.
- [Realm](https://realm.io/docs/xamarin/latest/): Alternative to SQLite, simple and fast.
- [SQLite-net ★2941](https://github.com/praeclarum/sqlite-net): It is an open source, minimal library to allow .NET and Mono applications to store data in SQLite 3 databases.
...
- [MVVMCross ★3498](https://github.com/MvvmCross/MvvmCross): Cross-platform mvvm mobile development framework.
...
- [Prism ★4497](https://github.com/PrismLibrary/Prism): Nice framework with an amazing navigation service.
...
- [Fabulous ★824](https://github.com/fsprojects/Fabulous): F# Functional App Development - Elmish for Xamarin.Forms https://fsprojects.github.io/Fabulous/
...
- [InAppBillingPlugin ★284](https://github.com/jamesmontemagno/InAppBillingPlugin): A simple In-App Purchase plugin for Xamarin and Windows to query item information, purchase items, restore items, and more.
...
- [LibVLCSharp ★783](https://github.com/videolan/libvlcsharp): Xamarin bindings for libvlc, the multimedia framework powering the VLC applications made by VideoLAN.
...
- [MediaGallery ★26](https://github.com/dimonovdd/Xamarin.MediaGallery): Picking and saving photos and video files from the native gallery
- [MediaManager ★667](https://github.com/martijn00/XamarinMediaManager): Cross platform media plugin for Xamarin and Windows.
...
- [Plugin.LocalNotification ★139](https://github.com/tmt242001/Plugin.LocalNotification): The local notification plugin provides a way to show local notifications from Xamarin.Forms apps.
...
- [ZXing.Net.Mobile ★924](https://github.com/Redth/ZXing.Net.Mobile):  The goal of ZXing.Net.Mobile is to make scanning barcodes as effortless and painless as possible in your own applications.
...
- [AsyncAwaitBestPractices ★723](https://github.com/brminnick/AsyncAwaitBestPractices): A Xamarin.Forms app for displaying the top posts on Hacker News that demonstrates best practices for Async/Await.
- [Gastropods ★127](https://github.com/davidortinau/Gastropods): Xamarin.Forms Shell (Early Preview) sample.
- [Prism Samples Forms ★332](https://github.com/PrismLibrary/Prism-Samples-Forms): Samples that demonstrate how to use various Prism features with Xamarin.Forms.
...
- [JSON.NET ★8551](https://github.com/JamesNK/Newtonsoft.Json): Is a popular high-performance JSON framework for .NET
- [Utf8Json ★2049](https://github.com/neuecc/Utf8Json): Definitely Fastest and Zero Allocation JSON Serializer for C#(.NET, .NET Core, Unity and Xamarin), this serializer write/read directly to UTF8 binary so boostup performance.

## Testing

- [Xamarin.Forms.Mocks ★182](https://github.com/jonathanpeppers/Xamarin.Forms.Mocks): Library for running Xamarin.Forms inside of unit tests.
...
- [scrcpy ★48558](https://github.com/Genymobile/scrcpy): This application provides display and control of Android devices connected on USB (or over TCP/IP). It does not require any root access. It works on GNU/Linux, Windows and MacOS.
...
- [NSwag ★4316](https://github.com/RSuter/NSwag): Swagger and code generation tool for C#. Easily integrate your own or 3rd party APIs into your app.
...
- [AiForms.Dialogs ★144](https://github.com/muak/AiForms.Dialogs): This is a collection of Custom Dialogs that can be defined with XAML for Xamarin.Forms (Android / iOS).
...
- [ACR User Dialogs ★844](https://github.com/aritchie/userdialogs): A cross platform library that allows you to call for standard user dialogs from a shared/portable library.
...
- [CardsView ★610](https://github.com/AndreiMisiukevich/CardView): CardsView & CarouselView for Xamarin.Forms.
...
- [Forms9Patch ★117](https://github.com/baskren/Forms9Patch): Simplify image management and text formatting in your Xamarin.Forms apps.
...
- [GraphicsControls ★198](https://github.com/dotnet/GraphicsControls): Experimental GraphicsControls - Build drawn controls (Cupertino, Fluent and Material).
...
- [MagicGradients ★269](https://github.com/mgierlasinski/MagicGradients): Xamarin.Forms control to display complex gradients, insipired by PancakeView and Magic Gradients. You can add unlimited amount of linear gradients with different angles to create uniqe effects. Powered by SkiaSharp.
...
- [Microcharts ★1546](https://github.com/aloisdeniel/Microcharts): Is an extremely simple charting library for a wide range of platforms.
...
- [Rg.Plugins.Popup ★990](https://github.com/rotorgames/Rg.Plugins.Popup): Popup Page Plugin for Xamarin Forms.
...
- [Sharpnado.Shadows ★265](https://github.com/roubachof/Sharpnado.Shadows): Add as many custom shadows as you like to any Xamarin.Forms view (Android, iOS, UWP, Tizen).
...
- [TemplateUI ★282](https://github.com/jsuarezruiz/TemplateUI): A set of templated controls.
...
- [Ultimate-Xamarin-Forms-KIT ★110](https://github.com/bulubuloa/Ultimate-Xamarin-Forms-KIT): Xamarin.Forms Charts.
...
- [XF-Material-Library ★553](https://github.com/contrix09/XF-Material-Library): A Xamarin Forms library for implementing Material Design: Cards, Buttons, Chips, etc.
...
- [XamarinForms.CalendarControl ★42](https://github.com/DamianAntonowicz/XamarinForms.CalendarControl): Calendar control for Xamarin.Forms.
...
- [Xamarin.Forms.GoogleMaps.Clustering ★25](https://github.com/mierzynskim/Xamarin.Forms.GoogleMaps.Clustering): A map library that brings support for clustering for Xamarin.Forms.GoogleMaps.
...
- [Xamarin.Forms.InputKit ★392](https://github.com/enisn/Xamarin.Forms.InputKit): CheckBox, Radio Button, Labeled Slider, Dropdows etc. 
...
- [Xamarin.Forms.Nuke ★99](https://github.com/roubachof/Xamarin.Forms.Nuke): The famous iOS Nuke native image caching library for Xamarin.Forms.
...
- [Xamarin.Plugin.Calendar ★181](https://github.com/lilcodelab/Xamarin.Plugin.Calendar): Simple customizable event calendar for Xamarin.Forms.
...
- [Xamarin.Plugin.SharedTransitions ★364](https://github.com/Evolutionlab/Xamarin.Plugin.SharedTransitions): Activate shared element transitions between pages in Xamarin.Forms (IOS/Android).
