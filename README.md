...
- [Xamarin Forms Advanced Template (v. 2) ★18](https://github.com/SnowPowerCore/Xamarin-Forms-Advanced-Template): Packed with the most useful things for the developer & even more (legacy Shell-like navigation, app settings, async commands, base files, pre-configured to performance projects & included useful services).
